...
sidebar_frame = Frame(root, width=200, height=600, bg="#34495e")
sidebar_frame.pack(side="left", fill="y")

content_frame = Frame(root, bg="#ecf0f1")
content_frame.pack(side="right", expand=True, fill="both")

# Create a label with a border and background color
image_label = Label(content_frame, bg="#3498db", bd=5, relief="solid")
image_label.pack(expand=True, fill="both")

# Control buttons frame in the sidebar
